Funcionalidade: Cálculo de Juros Compostos em API REST
...
Cenário: SimulacaoJurosCompostos01
	...
	Então o status code da reposta será 200 (OK)
	E o resultado será 12.682,42
...
Cenário: SimulacaoJurosCompostos02
	...
	Quando eu solicitar o cálculo do valor total a ser pago ao final do período
	Então o status code da reposta será 400 (Bad Request)
...
Cenário: SimulacaoJurosCompostos07
	...
	Quando eu solicitar o cálculo do valor total a ser pago ao final do período
	Então o status code da reposta será 200 (OK)
	E o resultado será 10.404,00
	
Cenário: SimulacaoJurosCompostos08
	Dado que o valor o valor do empréstimo é de R$ 0,00
	E que este empréstimo será por 0 meses
	E que a taxa de juros é de 0,00% ao mês
	Quando eu solicitar o cálculo do valor total a ser pago ao final do período
	Então o status code da reposta será 400 (Bad Request)

Cenário: SimulacaoJurosCompostos09
	Dado que o valor o valor do empréstimo é de R$ 20.000,00
	E que este empréstimo será por 36 meses
	E que a taxa de juros é de 6,00% ao mês
	Quando eu solicitar o cálculo do valor total a ser pago ao final do período
	Então o status code da reposta será 200 (OK)
	E o resultado será 162.945,04

Cenário: SimulacaoJurosCompostos10
	Dado que o valor o valor do empréstimo é de R$ 25.000,00
	E que este empréstimo será por 48 meses
	E que a taxa de juros é de 6,00% ao mês
	Quando eu solicitar o cálculo do valor total a ser pago ao final do período
	Então o status code da reposta será 200 (OK)
	E o resultado será 409.846,79

Cenário: SimulacaoJurosCompostos11
	Dado que o valor o valor do empréstimo é de R$ 30.000,00
	E que este empréstimo será por 3 meses
	E que a taxa de juros é de 3,00% ao mês
	Quando eu solicitar o cálculo do valor total a ser pago ao final do período
	Então o status code da reposta será 200 (OK)
	E o resultado será 32.781,81